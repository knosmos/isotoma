...
class Bezier {
    ...
    render() {
        ...
        let q1 = `(${r(1/3 * this.l.x/100 + 2/3 * this.c.x/100)},${r(1/3 * this.l.y/100 + 2/3 * this.c.y/100)})`;
        let q2 = `(${r(2/3 * this.c.x/100 + 1/3 * this.r.x/100)},${r(2/3 * this.c.y/100 + 1/3 * this.r.y/100)})`;
